...
@Component({
  ...
  template: `
      <div class="flex absolute top-8 left-6 right-6 justify-between">
          ...
          <ul class="hidden sm:flex text-white gap-12 items-center [&>li]:tab-index-0">
              <li>
              ...
              <li class="bg-white text-neutral-900 rounded-full px-6 py-2 transition duration-300 hover:bg-opacity-40 hover:text-white">
          ...
          <div id="menu" class="hidden absolute z-10 top-20 left-0 right-0 bg-white font-neutral-800">
              ...
              <ul class="text-center pb-8 pt-4 [&>li]:m-5">
                  <li class="text-xl font-boldest font-sans text-neutral-800">
                      <button>About</button>
                  </li>
                  <li class="text-xl font-boldest font-sans text-neutral-800">
                      <button>Service</button>
                  ...
                  <button class="text-l font-bold font-serif bg-yellow rounded-full m-2 px-6 py-4">
                      CONTACT
                  </button>
              </ul>
          </div>
